...
model_file_base='/ifs/loni/faculty/thompson/four_d/Faisal/Projects/NeuralNet_TBI/Outputs/0012310/Trained_models/25_points/Inverse_tracks/' + 'Epoch_' + str(training_epochs) +  '/3_layers/' + str(n_hidden_1) + '_' + str(n_hidden_2) + '_' + str(n_hidden_3) + '/'
