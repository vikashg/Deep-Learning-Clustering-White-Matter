...
model_file_base='/ifs/loni/faculty/thompson/four_d/Faisal/Projects/NeuralNet_TBI/Outputs/' + subj + '/archived_Trained_models_2/' + str(num_points) + '_points/Inverse_tracks/' + 'Epoch_' + str(training_epochs) + '/2_layers/' + str(n_hidden_1) + '_' + str(n_hidden_2) + '_' + 'Batch_size_' + str(batch_size) + '/'
...
with tf.Session() as sess:
    ...
    if ckpt_dir and ckpt_dir.model_checkpoint_path:
         ...
         saver.restore(sess, model_file_base)
         print('Model Loaded')
    else:
