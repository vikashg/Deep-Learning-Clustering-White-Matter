...
if (flag ==1 ):
	...
	training_file_name= base_dir + 'training_set_new_wo_cc_frontal_' + str(num_points) + '.txt'
	testing_file_name= base_dir + 'testing_set_new_wo_cc_frontal_' + str(num_points) + '.txt'
