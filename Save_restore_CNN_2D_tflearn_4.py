...
model.fit({'input': batch_X_train}, {'target': batch_ys_train}, n_epoch= num_extra_epoch,validation_set=({'input': batch_X_test}, {'target': batch_ys_test}), snapshot_step=100, show_metric=True, batch_size=3000, run_id='convnet_track')

total_epochs = num_epoch + num_extra_epoch
model_name=output_dir + 'CNN_conv2d_32_conv2d_64_fc_128_fc_256_epoch_' + str(total_epochs) + '.tflearn'
