...
output_file=base_dir + 'Output_file_' + '2_layers_' + str(n_hidden_1) + '_' + str(n_hidden_2) + '.txt'
...
model_file_base='/ifs/loni/faculty/thompson/four_d/Faisal/Projects/NeuralNet_TBI/Outputs/0012310/Trained_models/25_points/Inverse_tracks/2_layers/' + str(n_hidden_1) + '_' + str(n_hidden_2) + '/'
...
#            f.write("Epoch:", '%04d' % (epoch+1), "cost=", "{:.9f}".format(avg_cost))
    ...
    f.write("Accuracy:", accuracy.eval({x: batch_x_test, y: batch_y_test}))
