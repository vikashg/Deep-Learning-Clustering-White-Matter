...
# Network Parameters
n_hidden_1 = 81 # 1st layer number of features
n_hidden_2 = 27 # 2nd layer number of features
n_hidden_3 = 27 # 2nd layer number of features
...
model_file_base='/ifs/loni/faculty/thompson/four_d/Faisal/Projects/NeuralNet_TBI/Outputs/' + subj+ '/Trained_models/'+ str(num_points) + '_points/Inverse_tracks/' + 'Epoch_' + str(training_epochs) +  '/3_layers/' + str(n_hidden_1) + '_' + str(n_hidden_2) + '_' + str(n_hidden_3) + '_' + 'Batch_size_' + str(batch_size) + '/'
