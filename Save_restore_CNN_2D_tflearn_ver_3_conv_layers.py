...
model.fit({'input': batch_X_train}, {'target': batch_ys_train}, n_epoch= num_epoch,validation_set=({'input': batch_X_test}, {'target': batch_ys_test}), snapshot_step=100, show_metric=True, batch_size=3000, run_id='convnet_track_ver_3_conv_layers')
