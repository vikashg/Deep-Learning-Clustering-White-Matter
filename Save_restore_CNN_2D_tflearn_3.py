...
batch_xs_test, batch_ys_test = testClass.CreateBatches_XY(num_test_set, test_name_list, batch_size, num_fiber_bundles, Track_label_lookup, num_points)

batch_X_test = batch_xs_test.reshape([-1, num_points, 3, 1])

num_epoch=10
output_dir='/ifs/loni/faculty/thompson/four_d/Faisal/Projects/NeuralNet_TBI/Outputs/' + subj + '/Trained_models_CNN/' + str(num_points) + '_points_resampled/wo_cc_frontal/'
...
model_name=output_dir + 'CNN_conv2d_32_conv2d_64_fc_128_fc_256_2nd_run_epoch_' + str(num_epoch) + '.tflearn'
